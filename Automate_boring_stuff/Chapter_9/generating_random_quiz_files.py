...
for quiz_num in range(35):
    ...
    answers_key_file = open(f'capitalsquiz_answers{quiz_num + 1}.txt', 'w')
    ...
    for question_num in range(50):
        ...
        answers_key_file.write(f"{question_num + 1}. {'ABCD'[answer_options.index(correct_answer)]}")
    quiz_file.close()
    answers_key_file.close()
